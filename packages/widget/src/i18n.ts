...
const SUPPORTED_LANGS: Lang[] = ['zh-CN', 'en', 'ko', 'ru']

const translations: Record<Lang, Record<string, string>> = {
  'zh-CN': {
    'header.title': '在线咨询', 'header.welcome': '您好！有什么可以帮您的？', 'input.placeholder': '输入问题...', 'loading': '正在思考...', 'networkError': '网络异常，请稍后重试。',
  ...
  en: {
    'header.title': 'Online Support', 'header.welcome': 'Hello! How can I help you?', 'input.placeholder': 'Type your question...', 'loading': 'Thinking...', 'networkError': 'Network error, please try again.',
  ...
  ko: {
    'header.title': '온라인 상담', 'header.welcome': '안녕하세요! 무엇을 도와드릴까요?', 'input.placeholder': '질문을 입력하세요...', 'loading': '답변을 준비하고 있습니다...', 'networkError': '네트워크 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.',
  ...
  ru: {
    'header.title': 'Онлайн-консультация', 'header.welcome': 'Здравствуйте! Чем я могу помочь?', 'input.placeholder': 'Введите вопрос...', 'loading': 'Готовлю ответ...', 'networkError': 'Ошибка сети. Попробуйте ещё раз позже.',
